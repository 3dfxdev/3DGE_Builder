...
AppVerName=3DGE Builder 0.2
AppPublisher=IsotopeSoftWorks
AppPublisherURL=https://github.com/Corbachu
AppSupportURL=http://www.tdgmods.net/smf/viewforum.php?f=34
AppUpdatesURL=https://sourceforge.net/projects/edge2/files/3DGE%20Builder/
...
Source: Setup\SlimDX_Setup.url; DestDir: {tmp}; Flags: dontcopy
...
Name: {group}\{cm:UninstallProgram,3DGE Builder}; Filename: {uninstallexe}
...
[Registry]
Root: HKLM; Subkey: SOFTWARE\3DGE_TOOLS\3DGE Builder\; ValueType: string; ValueName: Location; ValueData: {app}; Flags: uninsdeletevalue
